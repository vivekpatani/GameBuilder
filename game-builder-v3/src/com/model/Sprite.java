...
public class Sprite implements Serializable {
	...
	private boolean loosingProperty;
	...
	public void setAttachTo (Sprite spriteObj) {
		this.attachTo = spriteObj;
	}
	
	public Sprite getAttachTo() {
		return attachTo;
	}
	
	public void setLoosingProperty(boolean value) {
		this.loosingProperty = value;
	}
	
	public boolean getLoosingProperty() {
		return loosingProperty;
	}
}

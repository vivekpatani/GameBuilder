...
public class KeyPressWithUDTest {
	...
	@Before
		public void setUp() {
			...
			actionList.add(Actions.MOVEVERTICALWITHUD);
	...
	public void testTriggerActionWithD() {
		keyPress.triggerAction(5);
		Assert.assertEquals(paddle.getY(),130);

	}
	
	@Test
	public void testTriggerActionWithU() {
		keyPress.triggerAction(4);

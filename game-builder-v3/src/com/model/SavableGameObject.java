...
public class SavableGameObject implements Serializable {
	...
	public SavableGameObject() {
		...
		this.wallConfigObj = Constants.wallConfigObj;
	}
	...
	*/
	public void setWallConfig(WallConfig wallConfigObj) {
		this.wallConfigObj = wallConfigObj;
		Constants.wallConfigObj = wallConfigObj;
	}
	
	public WallConfig getWallConfig() {
		return wallConfigObj;
	}
}
